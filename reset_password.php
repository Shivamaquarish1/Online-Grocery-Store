<?php
	if(isset($_POST["reset-password"])) {
		...
		$sql = "UPDATE `grocery_store`.`user` SET `u_pwd` = '" . md5($_POST["u_pwd"]). "' WHERE `user`.`u_pwd` = '" . $_GET["name"] . "'";
...
function validate_password_reset() {
	if((document.getElementById("u_pwd").value == "") && (document.getElementById("confirm_password").value == "")) {
