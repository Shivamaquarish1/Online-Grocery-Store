...
function validate_password_reset() {
	if((document.getElementById("u_pwd").value == "") && (document.getElementById("Confirm Password").value == "")) {
...
<form name="frmForgot" id="frmForgot" method="post" onSubmit="return validate_password_reset();">
	...
	<div class="field-group">
		...
		<div><input type="password" name="u_pwd" id="u_pwd" class="input-field"> Or</div>
	</div>
